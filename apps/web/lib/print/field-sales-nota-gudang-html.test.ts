...
const labels = { title: "NOTA GUDANG", doc: "No. Dokumen", orderRef: "Ref. Pesanan", store: "Toko", salesman: "Sales", date: "Tanggal", status: "Status", no: "No", product: "Produk", qty: "Qty", preparedBy: "Disiapkan", receivedBy: "Diterima", issuedBy: "Diterbitkan oleh" };

describe("buildNotaGudangPrintHtml", () => {
  it("renders title, delivery docNo, order ref, qty and NO price", () => {
    const html = buildNotaGudangPrintHtml({
      docNo: "PTG/2607/0001", orderNo: "PUTUS/2607/0001", storeName: "Toko A", salesmanName: "Budi", deliveredAt: "2026-07-20T00:00:00Z",
      status: "APPROVED",
