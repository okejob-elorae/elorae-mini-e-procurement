...
describe("classifyCompletionResult", () => {
  ...
  it.each([
    ...
    "NOT_CARRIER", "MISSING_PROOF", "MISSING_NOTA_PHOTO", "MISSING_SIGNED_BY", "KONSI_NOT_RESERVED", "NO_INVENTORY_ROW", "MISSING_GPS",
    "STORE_NOT_GEOCODED", "GPS_OUT_OF_RADIUS", "MISSING_DATES", "MISSING_CARRIER", "MISSING_RESI",
    "OVER_DELIVER", "INSUFFICIENT_STOCK", "INVALID_DATES", "SHIPMENT_IN_FLIGHT", "INVALID_REQUEST",
