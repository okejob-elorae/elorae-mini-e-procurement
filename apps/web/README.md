...
An ERP for textile and garment manufacturing, covering three domains: **procurement and production** (suppliers, purchase orders, goods receipt, inventory, work orders, vendor returns, supplier payments), **field sales** (field-sales orders putus/konsi, canvassing van sales, SPG store sales, store stocktakes, field returns — with a PWA for the people in the field), and **finance** (AR ledger, payment recording, collections, store settlement, general ledger and faktur pajak). Plus settings: UOM, tax, document numbering, RBAC.
