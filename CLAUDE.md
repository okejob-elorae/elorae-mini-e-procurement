...
- Wondering why an already-45-days-overdue receivable gets one alert, not four? Only the highest crossed threshold fires per sweep pass — lower thresholds already skipped past are never revisited by design. See `docs/ARCHITECTURE-NOTES.md`.
