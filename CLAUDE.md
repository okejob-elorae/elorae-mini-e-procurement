...
| **10 (Radius check-in)** | Radius validation on check-in (anti-fraud, 17-01 AC) — configurable radius per store, block/warn on GPS violation. | ⬜ in progress (this session). |
