...
import { getStockCard, getStockCardByType, getCurrentStockSummary } from '@/app/actions/stock-card';
import { toast } from 'sonner';

const defaultFrom = startOfDay(subDays(new Date(), 30));
const defaultTo = endOfDay(new Date());

type ViewMode = 'by-item' | 'by-type';
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Movement history and running balance by item or by item type
          </p>
        </div>
      </div>
