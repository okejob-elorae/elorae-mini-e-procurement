/** Variant row stored on Item.variants JSON */
...
export type CatalogItemDraft = {
  /** Family / prefix for variant SKUs (e.g. 240000). */
  parentSku: string;
  /** Unique Item.sku stored in ERP (family, or family-G{item_group_id} when family collides). */
  itemSku: string;
  nameId: string;
  nameEn: string;
  description?: string;
